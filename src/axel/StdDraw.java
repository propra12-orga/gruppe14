...
public final class StdDraw implements ActionListener, MouseListener,
	...
	public static ImageIcon getTile(int tileType) {
		...
		switch (tileType) {
		case SOLID_WALL:
			image = new ImageIcon(getImage("graphics/solidwall.jpg"));
			break;
		case FLOOR:
			image = new ImageIcon(getImage("graphics/floor.png"));
			break;
		case BREAKABLE_WALL:
			// this needs to be adjusted as the appropriate image is added
			image = new ImageIcon(getImage("graphics/solidwall.jpg"));
			break;
		case EXIT:
			image = new ImageIcon(getImage("graphics/door.png"));
			break;
		}
		return image;
	}
